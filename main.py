...
class MatchCommands(commands.Cog):
    ...
    async def bo5_arena(self, interaction):
    ...
    async def bo7_arena(self, interaction):
    ...
    async def bo3_hcs(self, interaction):
    ...
    async def bo7_hcs(self, interaction):
    ...
    async def bo3_legacy(self, interaction):
    ...
    async def b05_legacy(self, interaction):
